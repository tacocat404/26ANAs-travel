import { AirplaneTilt, CalendarBlank, Images } from '@phosphor-icons/react'
import TripList from './TripList.jsx'
import HomeCalendar from './HomeCalendar.jsx'
import HomeGallery from './HomeGallery.jsx'

const TABS = [
  ['trips', '여행', AirplaneTilt],
  ['cal', '캘린더', CalendarBlank],
  ['gallery', '갤러리', Images],
]

// 홈(메인) 화면: 여행 목록 + 여행 단위 캘린더 + 여행별 갤러리.
...
export default function Home({ db, me, refresh, onOpen, tab, setTab }) {
  return (
    <main className="page">
      ...
      {tab === 'trips' && <TripList db={db} me={me} refresh={refresh} onOpen={onOpen} />}
